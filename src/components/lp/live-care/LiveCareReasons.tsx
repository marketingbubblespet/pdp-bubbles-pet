  ...
  return (
    <section className="bg-white py-16 md:py-24 px-4 border-t border-[#E5E7EB]">
      <div className="max-w-[1100px] mx-auto">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-[#0F0C0D] text-center mb-4 max-w-[720px] mx-auto">
          Uma hora de domingo que muda a forma como você fecha o atendimento
        </h2>
        <p className="text-sm md:text-base text-[#6B7280] text-center mb-10 max-w-[620px] mx-auto">
          ...
          {LIVE_CARE_REASONS.map((r) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-extrabold text-[#0F0C0D] leading-snug">{r.title}</h3>
