  ...
  return (
    <section className="bg-[#fdf0f3] py-16 md:py-24 px-4">
      <div className="max-w-[1100px] mx-auto">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-[#0F0C0D] text-center mb-4 max-w-[760px] mx-auto">
          ...
          {LIVE_CARE_PRODUCTS.map((p) => (
            ...
            >
              ...
              <div className="p-3 md:p-4">
                <p className="text-sm font-bold text-[#0F0C0D] leading-snug">{p.nome}</p>
                <p className="text-xs text-[#9ca3af] mt-0.5">{p.volume}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col items-center gap-3 mt-10">
          ...
          <p className="text-xs text-[#6B7280] text-center max-w-[420px]">
