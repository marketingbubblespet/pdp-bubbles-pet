...
const KEY = 'mca-exit-last-shown'
const THROTTLE_MS = 5 * 60 * 1000

export function ExitPopupAgosto() {
    ...
    >
      ...
      >
        ...
        <h3 className="text-xl md:text-2xl font-black text-white tracking-tight mb-2 leading-tight">
          Não perca a MasterClass de Rostinho Bebê
        </h3>
        <p className="text-sm text-white/70 mb-6">
          Aula ao vivo em {MC.date} às {MC.time}. Fale com a gente no WhatsApp e garanta seu acesso
          antes que as vagas acabem.
        </p>

        <WhatsappGate
          href={`${MC.whatsapp}?text=${encodeURIComponent(MC.whatsappReminderMsg)}`}
          ctaLocation="masterclass-rostinho-popup-saida"
