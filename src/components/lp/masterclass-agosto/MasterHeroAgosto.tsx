...
export function MasterHeroAgosto() {
  return (
    <section className="bg-[#080808] pt-10 pb-14 md:pt-16 md:pb-20 px-4">
      <div className="max-w-[1100px] mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div>
          ...
          <div className="inline-flex items-center gap-2 bg-[#111111] border border-white/5 rounded-full px-3.5 py-2 mb-4">
            ...
            <p className="text-xs md:text-sm font-bold text-white">
              ...
              <span className="font-medium text-white/60"> · site, WhatsApp ou distribuidores oficiais</span>
            </p>
          </div>
        ...
        <div className="max-w-[320px] mx-auto md:max-w-none">
          <div className="relative aspect-[4/5] md:max-h-[90vh] rounded-3xl overflow-hidden shadow-[0_0_20px_rgba(244,205,212,0.2)]">
            <Image
