...
import { MC_AUDIENCE, MC_NOT_AUDIENCE } from '@/lib/masterclass-agosto'

export function MasterAudienceAgosto() {
  return (
          ...
          <div className="bg-[#111111] rounded-2xl p-6 md:p-8 border border-white/5">
            ...
            {MC_NOT_AUDIENCE.length > 0 ? (
              ...
              <div className="flex flex-col gap-3 h-full justify-between">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#F4CDD4] text-center mt-1">
