...
export function FloatingWhatsAppAgosto() {
  ...
  return (
    <WhatsappGate
      href={waLink}
      ctaLocation="masterclass-rostinho-flutuante"
      ctaLabel="Falar no WhatsApp (botão flutuante)"
      theme="dark"
      className={`fixed right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:scale-105 active:scale-95 transition-all ${
