    ...
    <section className="bg-white py-16 md:py-24 px-4 border-t border-[#E5E7EB]">
      <div className="max-w-[900px] mx-auto">
        <Reveal>
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-[#0D0C0D] text-center mb-12">
          ...
          {CARE_HOW_IT_WORKS.map((item, i) => (
            <Reveal key={item.step} delay={i * 150}>
              <div className="flex flex-col items-center text-center gap-3">
                <div className="w-11 h-11 rounded-full bg-[#E8649A] text-white font-medium flex items-center justify-center text-lg transition-transform duration-300 hover:scale-110">
                  {item.step}
                </div>
