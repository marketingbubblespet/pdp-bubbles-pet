    ...
    <section className="bg-white py-16 md:py-24 px-4 border-t border-[#E5E7EB]">
      <div className="max-w-[900px] mx-auto">
        <Reveal>
          ...
          <p className="text-sm md:text-base text-[#666666] text-center leading-relaxed max-w-[720px] mx-auto mb-8">
        ...
        <Reveal delay={100}>
          <ul className="grid sm:grid-cols-2 gap-3 mb-8 max-w-[720px] mx-auto">
            {CARE_CONNECTION.bullets.map((bullet) => (
              <li key={bullet} className="flex items-start gap-2 bg-[#F7F7F7] rounded-xl p-4 text-sm text-[#0D0C0D] font-medium">
        ...
        <Reveal delay={200}>
          <div className="bg-[#fdf0f3] rounded-2xl p-6 md:p-8 text-center max-w-[720px] mx-auto">
            <p className="text-base md:text-lg font-medium text-[#0D0C0D]">
