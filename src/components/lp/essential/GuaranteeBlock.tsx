      ...
      <div className="max-w-[1100px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 mb-10">
          ...
          <div>
            ...
            <h3 className="text-lg md:text-xl font-semibold text-[#0D0C0D] mb-2">
              Troca em 7 dias, sem burocracia.
            </h3>
            <p className="text-[#666666] leading-relaxed mb-3 text-sm md:text-base">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {paymentMethods.map((m) => (
                <div key={m} className="flex items-center gap-1 border border-[#E5E7EB] rounded-lg px-2.5 py-1">
                  <CreditCard size={12} className="text-[#666666]" />
                  <span className="text-xs font-medium text-[#666666]">{m}</span>
                </div>
              ))}
            </div>
            <p className="text-xs text-[#666666]">🔒 Loja verificada Shopify</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 md:gap-3 border border-[#E5E7EB] rounded-xl px-4 md:px-6 py-3 md:py-4 bg-white">
          ...
          <p className="text-xs md:text-sm font-medium text-[#0D0C0D]">
